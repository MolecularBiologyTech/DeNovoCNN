...
./Versions/v.1.1.2/DeNovoCNN_Installer_v.1.1.2.sh --use-conda --install-dir /path/to/installation
```

**Version History:**
- v.1.1.2: Added tools/ subdirectory structure for better organization
...
# Example:
./Versions/v.1.1.2/DeNovoCNN_Installer_v.1.1.2.sh --use-conda --install-dir /Users/matteozoia/tools/DeNovoCNN
```
