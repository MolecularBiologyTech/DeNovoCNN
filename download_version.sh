...
# DeNovoCNN Version Downloader
# This script allows you to download a specific version of DeNovoCNN

REPO_URL="https://github.com/MolecularBiologyTech/DeNovoCNN"
REPO_NAME="DeNovoCNN"

echo "=========================================="
echo "DeNovoCNN Version Downloader"
echo "=========================================="
echo ""
...
INSTALLER_FILE="temp_repo/Versions/$SELECTED_TAG/DeNovoCNN_Installer_${SELECTED_TAG}.sh"
...
cp "$INSTALLER_FILE" "./DeNovoCNN_Installer_${SELECTED_TAG}.sh"
chmod +x "./DeNovoCNN_Installer_${SELECTED_TAG}.sh"
...
echo "=========================================="
echo "Downloaded: DeNovoCNN_Installer_${SELECTED_TAG}.sh"
echo "Location: $(pwd)"
echo ""
echo "To install DeNovoCNN, run:"
echo "  ./DeNovoCNN_Installer_${SELECTED_TAG}.sh --use-conda --install-dir /path/to/installation"
echo "=========================================="
